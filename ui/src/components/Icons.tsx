...
export const IconMoon = ({size = 24}: IconMoonProps): JSX.Element => (
  <svg xmlns="http://www.w3.org/2000/svg" height={size} width={size} viewBox="0 0 384 512" fill="currentColor">
...
export const IconSun = ({size = 24}: IconSunProps): JSX.Element => (
  <svg xmlns="http://www.w3.org/2000/svg" height={size} width={size} viewBox="0 0 512 512" fill="currentColor">
...
export const IconSystem = ({size = 24}: IconSystemProps): JSX.Element => (
  <svg xmlns="http://www.w3.org/2000/svg" height={size} width={size} viewBox="0 0 512 512" fill="currentColor">
