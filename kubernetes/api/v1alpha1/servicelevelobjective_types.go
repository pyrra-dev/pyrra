...
type Alerting struct {
	...
	// +optional
	// Severities sets the Prometheus alert label "severity" per burn-rate tier and for absent alerts.
	// Pyrra defaults to critical for fast/medium burn and absent; warning for slow/long-term.
	Severities *AlertingSeverities `json:"severities,omitempty"`
}
...
type AlertingSeverities struct {
	...
	// +optional
	FastBurn string `json:"fastBurn,omitempty"`
	// +optional
	MediumBurn string `json:"mediumBurn,omitempty"`
	// +optional
	SlowBurn string `json:"slowBurn,omitempty"`
	// +optional
	LongTermBurn string `json:"longTermBurn,omitempty"`
}
...
func (in *ServiceLevelObjective) Internal() (slo.Objective, error) {
	...
	if in.Spec.Alerting.Severities != nil {
		alerting.Severities.Absent = in.Spec.Alerting.Severities.Absent
		alerting.Severities.FastBurn = in.Spec.Alerting.Severities.FastBurn
		alerting.Severities.MediumBurn = in.Spec.Alerting.Severities.MediumBurn
		alerting.Severities.SlowBurn = in.Spec.Alerting.Severities.SlowBurn
		alerting.Severities.LongTermBurn = in.Spec.Alerting.Severities.LongTermBurn
	}
