...
func (in *Alerting) DeepCopyInto(out *Alerting) {
	*out = *in
	...
	if in.Burnrates != nil {
		in, out := &in.Burnrates, &out.Burnrates
		*out = new(bool)
		**out = **in
	}
	if in.Absent != nil {
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *AlertingSeverities) DeepCopyInto(out *AlertingSeverities) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AlertingSeverities.
func (in *AlertingSeverities) DeepCopy() *AlertingSeverities {
	if in == nil {
		return nil
	}
	out := new(AlertingSeverities)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RuleOutput) DeepCopyInto(out *RuleOutput) {
	*out = *in
	if in.ShortRulesLabels != nil {
		in, out := &in.ShortRulesLabels, &out.ShortRulesLabels
		*out = make(map[string]string, len(*in))
		for key, val := range *in {
			(*out)[key] = val
		}
	}
	if in.LongRulesLabels != nil {
		in, out := &in.LongRulesLabels, &out.LongRulesLabels
		*out = make(map[string]string, len(*in))
		for key, val := range *in {
			(*out)[key] = val
		}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RuleOutput.
func (in *RuleOutput) DeepCopy() *RuleOutput {
	if in == nil {
		return nil
	}
	out := new(RuleOutput)
...
func (in *ServiceLevelIndicator) DeepCopyInto(out *ServiceLevelIndicator) {
	*out = *in
	...
	if in.BoolGauge != nil {
		in, out := &in.BoolGauge, &out.BoolGauge
		*out = new(BoolGaugeIndicator)
		(*in).DeepCopyInto(*out)
	}
}
...
func (in *ServiceLevelObjectiveSpec) DeepCopyInto(out *ServiceLevelObjectiveSpec) {
	*out = *in
	...
	if in.RuleOutput != nil {
		in, out := &in.RuleOutput, &out.RuleOutput
		*out = new(RuleOutput)
		(*in).DeepCopyInto(*out)
	}
}
