						...
						},
						{
							...
							Rules: []monitoringv1.Rule{
								...
								},
								{
									...
									Labels:      map[string]string{"burnrate_tier": "fast", "severity": "critical", "job": "app", "long": "1h", "slo": "http", "short": "5m", "team": "foo", "exhaustion": "2d"},
								...
								},
								{
									...
									Labels:      map[string]string{"burnrate_tier": "medium", "severity": "critical", "job": "app", "long": "6h", "slo": "http", "short": "30m", "team": "foo", "exhaustion": "4d"},
									Annotations: map[string]string{"description": "foo"},
								},
								{
									Alert:       "ErrorBudgetBurn",
									...
									Labels:      map[string]string{"burnrate_tier": "slow", "severity": "warning", "job": "app", "long": "1d", "slo": "http", "short": "2h", "team": "foo", "exhaustion": "2w"},
									Annotations: map[string]string{"description": "foo"},
								},
								{
									Alert:       "ErrorBudgetBurn",
									...
									Labels:      map[string]string{"burnrate_tier": "long-term", "severity": "warning", "job": "app", "long": "4d", "slo": "http", "short": "6h", "team": "foo", "exhaustion": "4w"},
									Annotations: map[string]string{"description": "foo"},
								},
							},
						},
