...
func (s *ObjectivesApiService) GetMultiBurnrateAlerts(ctx context.Context, name string) (ImplResponse, error) {
...
func (s *ObjectivesApiService) GetObjective(ctx context.Context, name string) (ImplResponse, error) {
...
func (s *ObjectivesApiService) GetObjectiveStatus(ctx context.Context, name string) (ImplResponse, error) {
